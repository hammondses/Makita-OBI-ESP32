...
- Este gráfico es útil para ver si una celda cae de voltaje más rápido que las demás cuando la batería está conectada a una herramienta en funcionamiento.
...
4. El ESP32 se reiniciará. Ahora podrás acceder a él desde cualquier dispositivo de tu red local sin cambiar de WiFi.
...
- **Bloqueada**: El BMS ha detectado un fallo crítico y ha bloqueado la batería (No cargará ni descargará en herramientas originales).
